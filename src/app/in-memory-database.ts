...
export class InMemoryDatabase implements InMemoryDbService {
    createDb() {
        ...
        const entries: Entry[] = [
            ...
            { id: 4, name: 'Salário da Empresa', categoryId: categories[3].id, category: categories[3], paid: true, date: '14/10/2018', amount: '3000,00', type: 'expense', description: 'Salário da Empresa' } as Entry,
            ...
            { id: 8, name: 'Salário da Escola', categoryId: categories[4].id, category: categories[4], paid: true, date: '14/10/2018', amount: '1100', type: 'expense', description: 'Salário da Escola' } as Entry,
